...
export const PERMISSION_VALUES = [
  ...
  "auth.logout",
  "dashboard.read",
  "dashboard.read_summary",
  "dashboard.read_stock_chart",
  "dashboard.read_inventory_value",
  "dashboard.read_alerts",
  ...
  "warehouse.read",
  "warehouse.read_map",
  "warehouse.read_stock",
  "warehouse.pick_location",
  "warehouse.create",
  "warehouse.update",
  "warehouse.delete",
  "stock.read",
  ...
  "monitoring.read_worker",
  "monitoring.read_response_time",
  "audit_log.read",
...
export const PERMISSION_LABELS: Record<Permission, string> = {
  ...
  "dashboard.read_summary": "Lihat Ringkasan Dashboard",
  "dashboard.read_stock_chart": "Lihat Grafik Stok",
  "dashboard.read_inventory_value": "Lihat Nilai Inventaris",
  "dashboard.read_alerts": "Lihat Alert Dashboard",
  "dashboard.export_pdf": "Export PDF Dashboard",
  ...
  "profile.change_password": "Ubah Password Sendiri",
  "profile.activity.read": "Lihat Aktivitas Sendiri",
  "product.read": "Lihat Produk",
  "product.create": "Buat Produk",
  "product.update": "Ubah Produk",
  "product.delete": "Nonaktifkan Produk",
  "product.upload_image": "Upload Gambar Produk",
  ...
  "warehouse.read_map": "Lihat Peta Gudang",
  "warehouse.read_stock": "Lihat Stok Gudang",
  "warehouse.pick_location": "Pilih Lokasi Gudang",
  ...
  "transfer.read": "Lihat Transfer",
  "transfer.create": "Buat Transfer",
  "transfer.complete": "Selesaikan Transfer",
  "transfer.cancel": "Batalkan Transfer",
  "transfer.validate": "Validasi Transfer",
  "import.read": "Lihat Import",
  "import.template_download": "Download Template Import",
  "import.create": "Buat Import",
  "import.preview": "Preview Import",
  "import.execute": "Eksekusi Import",
  "import.rollback": "Rollback Import",
  "report.read": "Lihat Laporan",
  "report.generate": "Buat Laporan",
  "report.export_pdf": "Export PDF Laporan",
  "report.download": "Unduh Laporan",
  "job.read": "Lihat Job",
  "job.retry": "Ulangi Job",
  "job.cancel": "Batalkan Job",
  "sync.read": "Lihat Sinkronisasi",
  "sync.retry": "Ulangi Sinkronisasi",
  ...
  "monitoring.read_worker": "Lihat Worker",
  "monitoring.read_response_time": "Lihat Response Time",
...
export const AUDIT_ACTIONS = {
  ...
  WAREHOUSE_SYNC_COMPLETED: "WAREHOUSE_SYNC_COMPLETED",
  WAREHOUSE_SYNC_FAILED: "WAREHOUSE_SYNC_FAILED",
  WAREHOUSE_SYNC_STARTED: "WAREHOUSE_SYNC_STARTED",
